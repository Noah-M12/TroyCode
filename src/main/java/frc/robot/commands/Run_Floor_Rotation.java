...
public class Run_Floor_Rotation extends Command {

    private final double speed;
    private final Floor_Intake Floor_Intake;

    public Run_Floor_Rotation(Floor_Intake Floor_Intake, double speed) {
    ...
    @Override
    public void execute() {
        Floor_Intake.run_Floor_Rotation(speed);
    }

    @Override
    public void end(boolean interrupted) {
        Floor_Intake.run_Floor_Rotation(0);
    }
