...
public class Run_Algea_Wrist extends Command{
   ...
   */
  public Run_Algea_Wrist(AlgeaIntake AlgeaIntake, double speed) {
  ...
  @Override
  public void execute() {
    AlgeaIntake.runWrist(speed);
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    AlgeaIntake.runWrist(0);
